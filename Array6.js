 ...
 * Check whether every email address in the list of users is valid (get a true or false value)
    for checking the email address reg expession == /\S+@\S+\.\S+/  **/

let testEmail = users.every((users)=>/\S+@\S+\.\S+/.test(users.email))
...
// console.log(validateEmail('anystring@anystring.anystring'));// true
